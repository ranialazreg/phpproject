  ...
  <div class='app-content'>
    ...
    <div class='products-area-wrapper tableView'>
      <div class='products-header'>
        ...
        <form action="" method="POST" enctype="multipart/form-data" style='background-color: #101827;border:none;width:50%'>
        <h1 style='text-align:center;padding-bottom:20px;font-weight:bold'>ajout produits</h1>
       <input type="text" id="designation"  placeholder='designation'name="designation"  required>
       <input type="text" placeholder='libelle' id="libelle"   name="libelle"  required>
       <input type="number" placeholder='prix' id="prix"   name="prix"  required>
       <input type="number" id="quantite"  placeholder='quantite' name="quantite"  required>
       <input type="file"  placeholder="image"id="file" name="file" style="background-color:white"><br>

       <a href="produit.php" class="a" style='color:white;font-size:1.3em'>Liste des produits </a><br><br>
