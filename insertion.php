...
<img src='$lien' alt='Image' class='card-img-top'>    <div class='card-body'>
      ...
      <div class='cta-section'>
        <div>".$row['prix']."DT</div> 
        <a href='insertiondb?email=$emaiil&id=$id&img=$img&nom=$nom&prix=$prix' class='btn ' style='background-color:black;color:white;font-size:0.9em'  >Buy Now</a>
      </div>
    </div>
  </div>
  </div>
...
<img src='$lien' alt='Image' class='card-img-top'>    <div class='card-body'>
      ...
      <div class='cta-section'>
        <div>".$row['prix']."DT</div> 
        <a href='log in.php' class='btn ' style='background-color:black;color:white;font-size:0.9em'  >Buy Now</a>
      </div>
    </div>
  </div>
  </div>
