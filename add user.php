  ...
  <div class='app-content'>
    ...
    <div class='products-area-wrapper tableView'>
      <div class='products-header'>
        ...
        <form action="ex.php" method="post" enctype="multipart/form-data" style='background-color: #101827;border:none;width:50%'>
        <h2 style='text-align:center;padding-bottom:20px;font-weight:bold'>ajout users</h2>
        <input type="text" id="firstname" name="firstname" placeholder="Prenom"><span class="glyphicon glyphicon-user"></span></br>
        <input type="text" id="lastname" name="lastname"  placeholder="Nom" ><span class="glyphicon glyphicon-user"></span></br>
        <input type="email" id="firstname" name="email" placeholder="Email" ><span class="glyphicon glyphicon-envelope"></span></br>
        <input type="password" id="password" name="password"  placeholder="Mot de passe" ><span class="glyphicon glyphicon-pencil"></span></br>
        <input type="text" id="adresse" name="adresse"  placeholder="Adresse" ><span class="glyphicon glyphicon-map-marker"></span></br>
        <input type="text" id="tel" name="tel" placeholder="numero de téléphone" ><span class="glyphicon glyphicon-phone"></span></br>
...
<?php 
 ...
 function formulaireSoumis() {
  ...
  if(formulaireSoumis()){
    ...
    //Enrrgistrement du produit dans la BD
    $req="INSERT INTO produit(designation,prix,image,quantite, libelle) VALUES('$design','$prix','$img','$quantite','$libelle')";
    if(mysqli_query($conn,$req)){
        echo "<script> alert('New record created ') ;</script>";
    }
    else{ echo "<script> alert('Echec Ajout') ;</script>"; }
    
    // Telechargement de l'img sur dans le repertoire 'images'
    $target_dir = "images/";
	$target_file = $target_dir . basename($_FILES["file"]["name"]);
	$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
	$uploadOk = 1;
	// Verifier si le fichier image est valide
	...
	//Vérifier si le fichier image existe déjà sur le serveur
	...
	if ($uploadOk == 1) {
		...
		/*if(move_uploaded_file($_FILES["file"]["tmp_name"], $target_file);) {
			 echo "Le fichier ". htmlspecialchars( basename( $_FILES["file"]["name"])). " a été téléchargé. <br>";
		}*/
	}
	...
	//Limiter la taille du fichier image
